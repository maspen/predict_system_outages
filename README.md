...
Before the decision to only use the Hardware and Software categories was made, correlations were computed for each column. 'correlation 1' was generated by categorizing the NaN entries using `astype('category').cat.codes`. 'correlation 2' was generated by also converting the "problem start datetime" and "problem end datetime" columns to `int64`. 'correlation 2' was created by comparing several imputers.
